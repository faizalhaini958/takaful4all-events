...
class BentongMonsoonMarathonSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $registrationFields = [
            ...
            ['key' => 'finisher_tee_size',       'label_en' => '42km Finisher Tee Size',   'label_ms' => 'Saiz Baju Finisher 42km', 'type' => 'select', 'required' => false, 'sort_order' => 14, 'locked' => false, 'options_en' => $tshirtSizes, 'options_ms' => $tshirtSizes, 'placeholder_en' => 'Select size (42km only)', 'placeholder_ms' => 'Pilih saiz (42km sahaja)'],
