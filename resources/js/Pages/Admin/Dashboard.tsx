                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <Link href="/admin/registrations" className="group">
                        <div className="rounded-xl border border-border/60 p-5 bg-card hover:border-primary/40 transition-all group-hover:shadow-md">
                            ...
                            <div className="flex gap-1.5 mt-3 flex-wrap">
                                ...
                                {stats.registrations.awaiting_payment > 0 && (
                                <span className="inline-flex items-center rounded-full border border-orange-500/30 bg-orange-500/10 px-2 py-0.5 text-[11px] font-semibold text-orange-600 dark:text-orange-400">
                                    <Clock className="w-3 h-3 mr-0.5" /> {stats.registrations.awaiting_payment}
                                </span>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-rows-2 gap-2">
                        <Link href="/admin/pages" className="group">
                            <div className="rounded-xl border border-border/60 px-3 py-2.5 xl:p-4 bg-card hover:border-primary/40 transition-all group-hover:shadow-md h-full flex items-center gap-3">
                                <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-accent">
                                    <FileText className="w-3.5 h-3.5 xl:w-4 xl:h-4 text-accent-foreground" />
                                </div>
                                <div>
                                    <p className="text-lg xl:text-2xl font-bold tabular-nums text-foreground leading-none">{stats.pages}</p>
                        ...
                        <Link href="/admin/media" className="group">
                            <div className="rounded-xl border border-border/60 px-3 py-2.5 xl:p-4 bg-card hover:border-primary/40 transition-all group-hover:shadow-md h-full flex items-center gap-3">
                                <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-accent">
                                    <Image className="w-3.5 h-3.5 xl:w-4 xl:h-4 text-accent-foreground" />
                                </div>
                                <div>
                                    <p className="text-lg xl:text-2xl font-bold tabular-nums text-foreground leading-none">{stats.media}</p>
