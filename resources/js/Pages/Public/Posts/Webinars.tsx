...
export default function WebinarsIndex({ webinars, canonicalUrl }: Props) {
    return (
        <PublicLayout>
            <Head>
                <title>Webinars | Takaful4All Events</title>
                <meta name="description" content="On-demand webinars from leading takaful experts. Stay informed with insights and knowledge from Takaful4All's webinar series." />
                <link rel="canonical" href={canonicalUrl} />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={canonicalUrl} />
                <meta property="og:title" content="Webinars | Takaful4All Events" />
                <meta property="og:description" content="On-demand webinars from leading takaful experts. Stay informed with insights and knowledge from Takaful4All's webinar series." />
                <meta property="og:site_name" content="Takaful4All Events" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Webinars | Takaful4All Events" />
                <meta name="twitter:description" content="On-demand webinars from leading takaful experts. Stay informed with insights and knowledge from Takaful4All's webinar series." />
            </Head>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-20">
                    {webinars.data.length > 0 ? (
                        ...
                        <div className="text-center py-24 flex flex-col items-center gap-4">
                            ...
                            <p style={{ fontFamily: POPPINS, color: '#071B2A', fontWeight: 700, fontSize: '1.125rem' }}>No webinars found.</p>
