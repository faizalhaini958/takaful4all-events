...
class StoreEventRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('content_html')) {
            $merges['content_html'] = Purify::config([
                'HTML.Allowed' => 'p,br,h1,h2,h3,h4,ul,ol,li,strong,em,a[href|class],img[src|alt|width|height|class],blockquote,table,thead,tbody,tr,th[colspan|rowspan],td[colspan|rowspan],u,s,code,pre,hr',
